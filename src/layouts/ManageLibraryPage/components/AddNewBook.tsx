...
export const AddNewBook = () =>{
    ...
    async function submitNewBook(){
        const url = `http://library-springboot-env.eba-rdqrpvgc.us-east-2.elasticbeanstalk.com/api/admin/secure/add/book`;
                ...
                <div className="card-body">
                    <form method="POST">
                        ...
                        <div className="col-md-12 mb-3">
                            ...
                            <textarea className="form-control" id="exampleFormControllTextarea1"  rows={3}
